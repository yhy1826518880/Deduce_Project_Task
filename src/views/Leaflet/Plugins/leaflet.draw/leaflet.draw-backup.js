    ...
    (L.drawLocal = {
      draw: {
        toolbar: {
          ...
          undo: { title: '删除上一个绘制的点', text: '删除上个点' },
          buttons: {
            polyline: '绘制线条',
            polygon: '绘制多边形',
            rectangle: '绘制矩形',
        ...
        handlers: {
          circle: { tooltip: { start: '点击开始画圆.' }, radius: '半径' },
          circlemarker: { tooltip: { start: '点击地图来绘制一个圆形标记' } },
          marker: { tooltip: { start: '点击地图来绘制一个标记' } },
          polygon: {
            tooltip: {
              start: '点击开始绘制形状',
              cont: '点击以继续绘制',
          ...
          polyline: {
            ...
            tooltip: {
              start: '点击开始绘制线条',
              cont: '点击以继续绘制线条',
              end: '点击最后一个绘制的点以结束绘制线条'
            }
          },
          rectangle: { tooltip: { start: '点击并拖动来绘制矩形' } },
          simpleshape: { tooltip: { end: '点击鼠标来结束绘制' } }
        }
      },
      edit: {
        toolbar: {
          actions: {
            ...
            cancel: { title: '取消修改, 放弃所有修改', text: '取消' },
            clearAll: { title: '清除所有绘制图层', text: '清除所有' }
          },
          buttons: {
            edit: '修改图层',
            editDisabled: '没有图层可以修改',
            remove: '删除图层',
        ...
        handlers: {
          edit: {
            tooltip: {
              text: '拖动标记或控件来编辑',
              subtext: '点击取消按钮，以取消编辑'
            }
          },
          remove: { tooltip: { text: '选中一个形状并删除' } }
        }
      }
    }),
    (L.Draw.Event = {}),
